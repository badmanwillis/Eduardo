...
void messageCb1(const std_msgs::Empty& toggle_msg){
    ...
    float flex_ros = flex_delta;
    flex_msg.data = flex_ros;
    flex.publish( &flex_msg );
    green = !green;   // blink the led
}
...
int main() {
    ...
    int step_rate = 10; // the wait time, in us. Essentially speed control for all motors.
